    ...
    >
      ...
      <div className="w-full max-w-6xl px-4">
        <div className={`skills-grid stagger-children ${isVisible ? 'visible' : ''}`}>
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="HTML">
            <img src="/icons/HTML.svg" alt="HTML" className="w-12 h-12 md:w-16 md:h-16" />
            <span className="text-xs block md:hidden mt-2">HTML</span>
          </div>
          
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="CSS">
            <img src="/icons/css.svg" alt="CSS" className="w-12 h-12 md:w-16 md:h-16" />
            <span className="text-xs block md:hidden mt-2">CSS</span>
          </div>
          
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="JavaScript">
          ...
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="TypeScript">
          ...
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="React">
          ...
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="Next.js">
          ...
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="Node.js">
          ...
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="Express">
          ...
          <div className="skill-item flex flex-col justify-center items-center p-3 md:p-4 rounded-lg hover:bg-gray-800/30 transition-all duration-300" data-tooltip="MongoDB">
